          ...
          <header id="header" id="home">
            ...
            <div class="container">
                <div class="row align-items-center justify-content-between d-flex">
                  <div id="logo">
                    <a href="{{route('login')}}"><img src="img/logo.png" alt="" title="" /></a>
                  </div>
            ...
            <div class="container">
                <div class="row d-flex align-items-center justify-content-center">
                    <div class="about-content col-lg-12">
                        ...
                        <p class="text-white link-nav"><a href="{{route('login')}}">Home </a>  <span class="lnr lnr-arrow-right"></span>  <a href="#"> Report Threat</a></p>
                    </div>											
                </div>
            </div>
        </section>
