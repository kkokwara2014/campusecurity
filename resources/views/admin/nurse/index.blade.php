        ...
        <div class="row">
            ...
            <section class="col-lg-10 connectedSortable">
                ...
                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default">
                    <span class="fa fa-plus"></span> Add Nurse
                </button>
                {{-- @endif --}}
                <br><br>
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-responsive table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        {{-- @if((Auth::user()->id==$nurse->id||Auth::user()->role->id==2||Auth::user()->role->id==1)) --}}
                                        ...
                                        <tr>
                                            ...
                                            {{-- <td style="text-align: center">
                                                <a href="{{ route('nurse.show',$nurse->id) }}"><span
                                            ...
                                            <td style="text-align: center">
                                                ...
                                                <a href="{{ route('nurse.edit',$nurse->id) }}"><span
                                            ...
                                            <td style="text-align: center">
                                                <form id="delete-form-{{$nurse->id}}" style="display: none"
                                                    action="{{ route('nurse.destroy',$nurse->id) }}" method="post">
                                                    {{ csrf_field() }}
                                                    {{method_field('DELETE')}}
                                                </form>
                                                <a href="" onclick="
                        ...
                        <form action="{{ route('nurse.store') }}" method="post">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title"><span class="fa fa-user"></span> Add Nurse
                                    </h4>
                                </div>
